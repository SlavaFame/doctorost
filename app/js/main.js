...
$(document).ready(function(){
	...
	$(".disease_info-head").click(function() {
		$(this).next().slideToggle(), 
		$(this).toggleClass("active")
	});

	$(".disease_collapse").click(function() {
		$(this).parent().parent().slideToggle(), 
		$(".disease_info-head").removeClass("active")
	});
...
$(".doctorCard__sertificates-main").slick({
	slidesToShow: 1,
	slidesToScroll: 1,
	fade: true,
	asNavFor: ".doctorCard__sertificates-nav",
	arrows: true,
	dots: false,
	//appendDots: $(".doctorCard__sertificates-main-nav"),
	appendArrows: $(".doctorCard__sertificates-main"),
...
$(".doctorCard__sertificates-nav").slick({
	slidesToShow: 9,
	slidesToScroll: 1,
	asNavFor: ".doctorCard__sertificates-main",
	dots: !1,
	//vertical: !0,
	centerMode: !1,
	infinite: !0,
